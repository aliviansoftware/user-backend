...
func NewUserRouter(u pkg.UserService, router *mux.Router, a *authHelper) *mux.Router {
...
func decodeUser(r *http.Request) (error, pkg.User) {
	var u pkg.User
	if r.Body == nil {
...
func decodeCredentials(r *http.Request) (error, pkg.Credentials) {
	var c pkg.Credentials
	if r.Body == nil {
